...
| `GET` | `/version` | Runtime metadata (python version, uptime, optional version/commit). |
| `GET` | `/metrics` | Minimal Prometheus-style counters and last build duration gauge (in-memory). |
